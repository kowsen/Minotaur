...
using BounceLogic.Systems;

namespace BounceLogic.Scenes
{
    public class BounceScene2 : Scene
    {
        ...
        public BounceScene2(ContentManager content, SpriteBatch spriteBatch, int width, int height) : base()
        {
            _content = content;
        ...
        public override void Initialize(EventBus bus)
        {
            ...
            _sm.AddSystem(new EndMessengerSystem(_bus, "bounce2_end", 5000));
        }
